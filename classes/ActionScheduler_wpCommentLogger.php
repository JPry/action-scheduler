...
class ActionScheduler_wpCommentLogger extends ActionScheduler_Logger {
	...
	/**
	 * Delete comment count cache whenever there is new comment or the status of a comment changes.
	 *
	 * Cache will be regenerated next time ActionScheduler_wpCommentLogger::filter_comment_count() is called.
	 */
